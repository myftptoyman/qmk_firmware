...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT( /* Base */
        KC_ESC,   KC_MYCM,   KC_WHOM,   KC_MAIL,  KC_CALC,    KC_MSEL,  KC_MSTP,  KC_MPRV,  KC_MPLY,  KC_MNXT,   KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_CALC,  KC_PSCR, RGB_MOD,  KC_PAUSE,
        KC_GRV,   KC_1,      KC_2,      KC_3,     KC_4,       KC_5,     KC_6,     KC_7,     KC_8,     KC_9,      KC_0,     KC_MINS,  KC_EQL,   RGB_TOG,  KC_INS,  RGB_HUI,  KC_PAUSE,  
        KC_TAB,   KC_Q,      KC_W,      KC_E,     KC_R,       KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,      KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_DEL,  KC_END,   KC_PGDN, 
        KC_CAPS,  KC_A,      KC_S,      KC_D,     KC_F,       KC_G,     KC_H,     KC_J,     KC_K,     KC_L,      KC_SCLN,  KC_QUOT,  KC_ENT,   KC_MUTE,                      
