...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT( /* Base */
        ...
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  KC_PSCR,  KC_SCRL,  KC_PAUS,  _______,    _______,  _______,  _______,   
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  KC_INS,   KC_HOME,  KC_PGUP,  _______,    _______,            _______,  
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  KC_DEL,   KC_END,   KC_PGUP,  _______,                        _______,   _______,
