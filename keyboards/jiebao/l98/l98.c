...
bool rgb_matrix_indicators_advanced_kb(uint8_t led_min, uint8_t led_max) {
    ...
    uint8_t r,g,b;
    uint8_t r1,g1,b1;
    r = rgb_matrix_ws2812_array[68].r;
    g = rgb_matrix_ws2812_array[68].g;
    b = rgb_matrix_ws2812_array[68].b;
    rgb_matrix_set_color(41,r,g,b);

    r1 = rgb_matrix_ws2812_array[92].r;
    g1 = rgb_matrix_ws2812_array[92].g;
    b1 = rgb_matrix_ws2812_array[92].b;
    rgb_matrix_set_color(93,r1,g1,b1);
