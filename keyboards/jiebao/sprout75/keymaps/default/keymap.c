...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        KC_LCTL,  KC_LCMD,  KC_LALT,  KC_SPC,             KC_RALT,  KC_SPC,   KC_SPC,             KC_RALT,  MO(_FL),  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______,   KC_USB,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,   _______,  KC_INS,   RGB_MOD,  _______,  
        _______,  KC_NO,    TO(_MBL), _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,  _______,  HS_BATQ,  RL_MOD, 
    ...
    [_MBL] = LAYOUT( /* Base  !*/
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,   KC_ENT,   KC_PGDN,          
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,            KC_UP,    KC_END,
        KC_LCTL,  KC_LALT,  KC_LCMD,  KC_SPC,             KC_RALT,  KC_SPC,   KC_SPC,             KC_RCMD,  MO(_MFL), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [_MFL] = LAYOUT( /* Base */
        _______,  KC_BRID,  KC_BRIU,  KC_F3,    KC_F4,    RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______,   KC_USB,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,   _______,  KC_INS,   RGB_MOD,  _______,  
        _______,  TO(_BL),  KC_NO,    _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,  _______,  HS_BATQ,  RL_MOD, 
        _______,  RGB_TOG,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_HUI,  _______,  _______,  MO(_DEFA),          RGB_VAI,  _______,
        _______,  _______,  _______,  EE_CLR,             _______,  EE_CLR,   EE_CLR,             _______,  _______, _______,  RGB_SPD,  RGB_VAD,  RGB_SPI),
    [_DEFA] = LAYOUT( /* Base */
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, 
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_TEST,  _______,  _______,  _______,  _______,  QK_BOOT,  
...
const uint16_t PROGMEM rgbrec_default_effects[RGBREC_CHANNEL_NUM][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
       ...
       ________, ________, ________, ________,           ________, ________, ________,           ________, ________, ________, HS_GREEN, HS_GREEN, HS_GREEN),
    ...
    [1] = LAYOUT(
       ...
       HS_RED,   ________, HS_RED,   ________,           ________, ________, ________,           ________, ________, ________, ________, ________, ________),
