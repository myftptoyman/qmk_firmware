...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT( /* Base */
        ...
        KC_LCTL,  KC_LCMD,    KC_LALT,    KC_SPC,             KC_SPC,   KC_SPC,             KC_SPC,   KC_RALT,              MO(1),    KC_LEFT,  KC_DOWN,   KC_RGHT,  KC_P0,    KC_PDOT 
        ),
    ...
    [1] = LAYOUT( /* FN */
        ...
        _______,  GU_TOGG,    _______,    EE_CLR,             EE_CLR,   EE_CLR,             EE_CLR,   KC_RCTL,              _______,  _______,  _______,   _______,  _______,  _______   
        )
};
